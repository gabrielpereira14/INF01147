...
{
       0,    72,    72,    76,    77,    78,    79,    80,    83,    84,
      87,    88,    89,    90,    93,    94,    95,    98,    99,   102,
     103,   107,   108,   110,   111,   113,   116,   118,   119,   122,
     123,   124,   125,   126,   127,   128,   129,   132,   133,   137,
...
static const yytype_int16 yypact[] =
{
     ...
     162,   162,   162,   162,   162,   162,   162,   162,    11,    11,
...
static const yytype_int8 yytable[] =
{
     ...
     125,    85,    86,    87,    88,     0,     0,    89,    77,    78,
      ...
      79,    80,     0,     0,    59,     0,     0,     0,     0,     0,
      81,    82,    83,    84,    60,    85,    86,    87,    88
};
...
static const yytype_int8 yycheck[] =
{
     ...
     122,    30,    31,    32,    33,    -1,    -1,    36,    13,    14,
      ...
      15,    16,    -1,    -1,    29,    -1,    -1,    -1,    -1,    -1,
      25,    26,    27,    28,    39,    30,    31,    32,    33
};
...
#line 72 "parser.y"
                                                           {(yyval.ast) = (yyvsp[0].ast); printAST((yyval.ast),0);  printASTToFile((yyval.ast), outputFileName);}
#line 1331 "y.tab.c"
    break;
...
#line 93 "parser.y"
                                                            { (yyval.ast) = astCreate(AST_VARDEC, 0, (yyvsp[-4].ast), astCreate(AST_SYMBOL, (yyvsp[-3].symbol), 0, 0, 0, 0), astCreate(AST_SYMBOL, (yyvsp[-1].symbol), 0, 0, 0, 0), 0); }
#line 1373 "y.tab.c"
    break;

  case 15: /* dec: type TK_IDENTIFIER '[' LIT_INT ']' vec_init ';'  */
#line 94 "parser.y"
                                                            { (yyval.ast) = astCreate(AST_VECDEC, 0, (yyvsp[-6].ast), astCreate(AST_SYMBOL, (yyvsp[-5].symbol), 0, 0, 0, 0), astCreate(AST_SYMBOL, (yyvsp[-3].symbol), 0, 0, 0, 0), (yyvsp[-1].ast)); }
#line 1379 "y.tab.c"
    break;

  case 16: /* dec: type TK_IDENTIFIER '(' paraml ')' block  */
#line 95 "parser.y"
                                                            { (yyval.ast) = astCreate(AST_FUNDEC, 0, (yyvsp[-5].ast), astCreate(AST_SYMBOL, (yyvsp[-4].symbol), 0, 0, 0, 0), (yyvsp[-2].ast), (yyvsp[0].ast)); }
#line 1385 "y.tab.c"
    break;
